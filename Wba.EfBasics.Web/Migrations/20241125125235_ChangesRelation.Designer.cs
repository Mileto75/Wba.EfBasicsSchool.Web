...
namespace Wba.EfBasics.Web.Migrations
{
    ...
    [Migration("20241125125235_ChangesRelation")]
    partial class ChangesRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Wba.EfBasics.Core.Entities.Address", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2024, 11, 25, 13, 52, 34, 811, DateTimeKind.Local).AddTicks(7167),
                            FullAdress = "Langestraat 67, 8370 Blankenberge"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2024, 11, 25, 13, 52, 34, 811, DateTimeKind.Local).AddTicks(7210),
            ...
            modelBuilder.Entity("Wba.EfBasics.Core.Entities.Course", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2024, 11, 25, 13, 52, 34, 811, DateTimeKind.Local).AddTicks(7368),
            ...
            modelBuilder.Entity("Wba.EfBasics.Core.Entities.Student", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2024, 11, 25, 13, 52, 34, 811, DateTimeKind.Local).AddTicks(7249),
                            Firstname = "Mark",
                            Lastname = "Knopfler"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2024, 11, 25, 13, 52, 34, 811, DateTimeKind.Local).AddTicks(7251),
                            Firstname = "Jimi",
                            Lastname = "Hendrix"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2024, 11, 25, 13, 52, 34, 811, DateTimeKind.Local).AddTicks(7253),
                            Firstname = "Rory",
                            Lastname = "Gallagher"
                        },
                        new
                        {
                            Id = 4,
                            Created = new DateTime(2024, 11, 25, 13, 52, 34, 811, DateTimeKind.Local).AddTicks(7254),
                            Firstname = "Tim",
                            Lastname = "Henson"
                        });
                });
            ...
            modelBuilder.Entity("Wba.EfBasics.Core.Entities.Teacher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddressId = 2,
                            Created = new DateTime(2024, 11, 25, 13, 52, 34, 811, DateTimeKind.Local).AddTicks(7245),
                            Firstname = "Bart",
                            Lastname = "Soete"
                        },
                        new
                        {
                            Id = 2,
                            AddressId = 1,
                            Created = new DateTime(2024, 11, 25, 13, 52, 34, 811, DateTimeKind.Local).AddTicks(7247),
                            Firstname = "Mileto",
                            Lastname = "Di Marco"
                        });
                });

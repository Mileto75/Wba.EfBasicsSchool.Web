...
namespace Wba.EfBasics.Web.Migrations
{
    ...
    [Migration("20241114080747_Seeding")]
            ...
            modelBuilder.Entity("Wba.EfBasics.Core.Entities.Address", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2024, 11, 14, 9, 7, 46, 981, DateTimeKind.Local).AddTicks(1703),
                            FullAdress = "Langestraat 67, 8370 Blankenberge"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2024, 11, 14, 9, 7, 46, 981, DateTimeKind.Local).AddTicks(1748),
            ...
            modelBuilder.Entity("Wba.EfBasics.Core.Entities.Course", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2024, 11, 14, 9, 7, 46, 981, DateTimeKind.Local).AddTicks(1764),
                            Name = "Web Backend",
                            TeacherId = 2
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2024, 11, 14, 9, 7, 46, 981, DateTimeKind.Local).AddTicks(1766),
            ...
            modelBuilder.Entity("Wba.EfBasics.Core.Entities.Student", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2024, 11, 14, 9, 7, 46, 981, DateTimeKind.Local).AddTicks(1757),
                            Firstname = "Mark",
                            Lastname = "Knopfler"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2024, 11, 14, 9, 7, 46, 981, DateTimeKind.Local).AddTicks(1758),
                            Firstname = "Jimi",
                            Lastname = "Hendrix"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2024, 11, 14, 9, 7, 46, 981, DateTimeKind.Local).AddTicks(1760),
                            Firstname = "Rory",
                            Lastname = "Gallagher"
                        },
                        new
                        {
                            Id = 4,
                            Created = new DateTime(2024, 11, 14, 9, 7, 46, 981, DateTimeKind.Local).AddTicks(1762),
                            Firstname = "Tim",
                            Lastname = "Henson"
                        });
                });
            ...
            modelBuilder.Entity("Wba.EfBasics.Core.Entities.Teacher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddressId = 2,
                            Created = new DateTime(2024, 11, 14, 9, 7, 46, 981, DateTimeKind.Local).AddTicks(1752),
                            Firstname = "Bart",
                            Lastname = "Soete"
                        },
                        new
                        {
                            Id = 2,
                            AddressId = 1,
                            Created = new DateTime(2024, 11, 14, 9, 7, 46, 981, DateTimeKind.Local).AddTicks(1755),
                            Firstname = "Mileto",
                            Lastname = "Di Marco"
                        });
                });
